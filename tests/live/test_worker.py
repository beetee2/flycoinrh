...
def test_worker_loads_and_resets_exactly_once_for_multiple_frames(adapter_files, tmp_path, monkeypatch):
    ...
    with LiveOwnership(tmp_path) as owner:
        ...
        init = {"repository_root": str(tmp_path), "purpose": "fixture", "files": adapter_files,
                ...
                "session_id": "fixture-worker", "generation": 1}
        ...
        thread.start()
        try:
            assert receive_packet(parent)["kind"] == "ready"
